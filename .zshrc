...
export PATH="$HOME/bin:/opt/local/bin:/opt/local/sbin:/opt/blackdown-jdk-1.4.1/bin:/opt/Acrobat5:/usr/lib/ccache/bin:/usr/local/bin:/usr/local/sbin:/sw/bin:/sw/sbin:/bin:/sbin:/usr/bin:/usr/sbin:/usr/X11R6/bin:/usr/games:/opt/local/lib/pgsql8/bin"
export LANG=C
export PAGER=less
...
export MANPATH="/opt/local/man:/sw/share/man:/usr/share/man:/usr/X11R6/man"
# we're going to drink the fink kool-aid a little
export PERL5LIB="/sw/lib/perl5:/sw/lib/perl5/darwin"
export DYLD_LIBRARY_PATH="/Users/richardc/hck/SDL_Perl.MacOSX/lib"
export EDITOR=vim
prompt_newline=$'\n%{\r%}'
